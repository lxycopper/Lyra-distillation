...
def load_model_from_checkpoint(
    ...
    # Ensure parameters land on this rank's GPU (torchrun sets LOCAL_RANK). Without this,
    # some code paths still use the default CUDA device (often 0), piling every rank onto GPU 0.
